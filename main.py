...
5. TWEET DESTACADO ("El post del día"): Selecciona la cita de mayor peso político del lote analizado. REGLA DE ORO: Debe ser el texto ORIGINAL, COMPLETO y TEXTUAL. Prohibido resumir, parafrasear o acortar el mensaje. Si es un hilo, toma el tweet principal que dispara la noticia. Piensa como un analista político: ¿cuál es la única declaración de hoy que altera el escenario o fija una agenda ineludible?
